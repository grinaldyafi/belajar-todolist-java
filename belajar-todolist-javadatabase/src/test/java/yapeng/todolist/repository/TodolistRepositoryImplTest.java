package yapeng.todolist.repository;
...
public class TodolistRepositoryImplTest {
    ...
    @Test
    void testGetAll() {
        todoListRepository.add(new Todolist("yafi"));
        todoListRepository.add(new Todolist("rasyad"));
        todoListRepository.add(new Todolist("grinaldy"));
